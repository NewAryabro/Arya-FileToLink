...
BOT_TOKEN = environ.get('BOT_TOKEN', "7003834548:AAHFsN6CRhPKca3819LkgX0apRC0z4YXq50")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://web-8mxire7tdssj.up-de-fra1-k8s-1.apps.run-on-seenode.com/")
